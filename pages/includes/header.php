...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="view.php?pages=odd" class="nav-link">Odd Even</a></li>
            <li class="nav-item"><a href="action.php?pages=prime" class="nav-link">Prime</a></li>
            <li class="nav-item"><a href="action.php?pages=home" class="nav-link">All Product</a></li>
